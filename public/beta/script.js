...
function onWindowLoad() {
  console.warn(
    `WARNING! You are running the BETA build of the Music Visualizer. This version is not gaurenteed to function as desired, if at all. In other words, if it doesn't work, it's not my fault.`
  );
